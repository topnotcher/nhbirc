...
//@NOTE: This does not have multi-channel support.
public class Seen {
	...
	public MessageHandler commandHandler = new MessageHandler() {
		public void handle(MessageEvent e) {
			...
			if ( ! acts.containsKey(nick.toLowerCase()) ) {
				irc.msg(chan, "Who the fuck is " + nick + "?");
			} else {
	...
	public MessageHandler lastSeenHandler = new MessageHandler() {
		public void handle(MessageEvent e) {
